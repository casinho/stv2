 ...
 */
class KommentarForm extends CFormModel
{
	public $name;
    public $kommentar;
	public $poster_id;
	...
	public function rules() {
		return array(
			...
			array('email', 'email'),
			array('email', 'unique', 'className' => 'User', 'attributeName'=>'user_mail', 'message' => Yii::t('user','nick_vergeben')),
			//array('user_nick', 'userExists'),
			array('user_nick', 'unique', 'className' => 'User', 'attributeName'=>'user_nick', 'message' => Yii::t('user','email_bereits_verwendet')),
