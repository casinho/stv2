...
/**
 * This is the model class for table "person_vorschlag".
 *
 * The followings are the available columns in table 'person_vorschlag':
 * @property string $person_vorschlag_id
 ...
 */
class PersonVorschlag extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PersonVorschlag the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('land_id, geburtsmonat, geburtstag, verstorben_flag, age, produzent_flag, musiker_flag, artwork_flag, ma_stolen_flag', 'numerical', 'integerOnly'=>true),
			...
			array('user_id, bearbeitet_user_id, ma_person_id, person_id', 'length', 'max'=>10),
			array('geburtsdatum, todesdatum, erstellt_datum, bearbeitet_datum, ma_geprueft_datum', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('person_vorschlag_id, vorname, nachname, spitzname, anzeige_name, voller_name, geschlecht, foto, tags, land_id, geburtsdatum, geburtsjahr, geburtsmonat, geburtstag, todesdatum, verstorben_flag, age, produzent_flag, musiker_flag, artwork_flag, user_id, erstellt_datum, bearbeitet_datum, bearbeitet_user_id, ma_person_id, ma_stolen_flag, ma_geprueft_datum, person_id', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'person_vorschlag_id' => 'Person Vorschlag',
			'vorname' => 'Vorname',
			'nachname' => 'Nachname',
			'spitzname' => 'Spitzname',
	...
	public function search()
	{
		...
		$criteria->compare('person_vorschlag_id',$this->person_vorschlag_id,true);
